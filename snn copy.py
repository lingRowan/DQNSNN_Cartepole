...
class STDP(nn.Module):
    ...
    * :attr:`inhibition_radius` to inhibit surrounding neurons (in all feature maps) within a particular radius.
    ...
    def forward(self, input_spikes, potentials, output_spikes, winners=None, kwta = 1, inhibition_radius = 0, noise_std=0.01):
        ...
        #print(sum(weight_update))
        self.conv_layer.weight += weight_update
