...
class CustomNavigationEnv(gym.Env):
    ...
    def generate_random_blocks(self, num_blocks=10, min_distance=2):
       ...
       # while len(blocks) < num_blocks:
        ...
        blocks = {(0 , 1) , (0,  7),  (4,  4),  (7,  10),  (3,  7),  (6,  1),  (10,  1),  (6,  8),  (3,  9),  (3,  2)}
       ...
       # action = select_action(state)  # Get the action from the SNN
        ...
        # Append the screen state to the frames
            ...
            if done:
                ...
                if different_steps == 0:
                    with open("different_steps.txt", "a") as f:
                        f.write(f"Config {config_idx} reached difference = 0 at episode {i_episode}\n")
